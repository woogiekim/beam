...
_DIFF_TAG_MATCH    = "     "                             # same as remote — no indicator
_DIFF_TAG_MODIFIED = "[bold bright_yellow] M [/] "   # different from remote
